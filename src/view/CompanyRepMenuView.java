...
/**
 * view class that provides console-based menu for company representatives
 * allows managing internships and application decisions, performing CRUD actions, and updating visibility
 */
public class CompanyRepMenuView {
    /** controller to perform company representative operations */
    private final CompanyRepController companyRepController;
    /** shared browser view for displaying/filtering internships */
    private final InternshipBrowserView browserView;
    /** shared scanner for console input */
    private static final Scanner sc = new Scanner(System.in);
    /** date formatter for consistent date input/output in yyyy-MM-dd format */
    private final DateTimeFormatter fmt = DateTimeFormatter.ofPattern("yyyy-MM-dd");

    /** construct view with required controller and shared browser view
     * @param companyRepController controller for company representative operations
     * @param browserView shared internship browser view
     */
    ...
    /**
     * display company representative menu and handle user actions
    ...
    /**
     * prompt user to create a new internship opportunity
     * @param rep company representative creating the internship
     */
    ...
    /**
     * retrieve and display list of internships created by the given company representative
     * @param rep company representative whose internships to retrieve
    ...
    /**
     * toggle visibility status of an internship
     * @param rep company representative performing the action
     */
    ...
    /**
     * view applications submitted for an internship
     * @param rep company representative performing the action
     */
    ...
    /**
     * approve or reject pending internship applications
     * @param rep company representative performing the action
     */
    ...
    /**
     * prompt company representative to change their password
     * @param rep company representative changing password
     */
    ...
    /**
     * print detailed list of internship applications
     * @param applications list of internship applications to display
     */
    private void printApplications(List<InternshipApplication> applications) {
    ...
    /**
     * prompt user to register as a new company representative
     */
     ...
     * @return true if email format is valid, else false
     */
    ...
    /**
     * prompt user to edit an existing internship opportunity
    ...
    /**
     * prompt user to delete an existing internship opportunity
     * @param rep company representative deleting the internship
     */
    ...
    /**
     * truncate a string to max 15 characters for display
     ...
     * @return true if user confirms with 'Y', false for 'N'
     */
